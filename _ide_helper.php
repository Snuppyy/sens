...
')
     ...
     */ 
        ...
        {
                        /** @var \Jrean\UserVerification\UserVerification $instance */
                        return $instance->generate($user);
        }
                    /**
        ...
        {
                        /** @var \Jrean\UserVerification\UserVerification $instance */
                        $instance->send($user, $subject, $from, $name);
        }
                    /**
        ...
        {
                        /** @var \Jrean\UserVerification\UserVerification $instance */
                        $instance->sendQueue($user, $subject, $from, $name);
        }
                    /**
        ...
        {
                        /** @var \Jrean\UserVerification\UserVerification $instance */
                        $instance->sendLater($delay, $user, $subject, $from, $name);
        }
                    /**
        ...
        {
                        /** @var \Jrean\UserVerification\UserVerification $instance */
                        return $instance->process($email, $token, $userTable);
        }
